...
```html
<script src="https://cdn.jsdelivr.net/npm/phone-mask-ruby@2.1.1/dist/phone-mask-ruby.min.js"></script>
```

or

```html
<script src="https://unpkg.com/phone-mask-ruby@2.1.1/dist/phone-mask-ruby.min.js"></script>
```
